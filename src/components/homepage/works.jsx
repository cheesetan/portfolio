				...
				body={
					<div className="works-body">
						<div className="work">
							...
							/>
							<div className="work-title">SST Incorporated</div>
							<div className="work-subtitle">iOS Taskforce</div>
						...
						<div className="work">
							<img
								...
								className="work-image"
							/>
							<div className="work-title">HMGICS</div>
							<div className="work-subtitle">
								Student Work Attachment
							</div>
							<div className="work-duration">December 2023</div>
						</div>

						<div className="work">
							<img
								src="https://github.com/swiftinsg/branding/blob/main/logos/icons/png/coloured%20-%20light%20background.png?raw=true"
								alt="swift accelerator programme"
								className="work-image"
							/>
							<div className="work-title">
								Swift Accelerator Programme
							</div>
							<div className="work-subtitle">Mentor</div>
							<div className="work-duration">
								May 2024 - Present
							</div>
						</div>
